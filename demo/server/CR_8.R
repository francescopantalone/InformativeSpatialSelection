...
# y values c(-100,-10,1,0,1,10,100)#
# varying y                        #
## ------------------------------ ##
# -- server -- #
...
for(i in 1:num_cores)
{
  ...
  Numden[[i]] <- parallelrho12_server(Y = Y[[i]],
                                      ...
                                      paramd = compatible(do.call(expand.grid, list(
                                        ...
                                        .Gamma = 1))),
                                      ncores = 1)
  save(Numden, file = "CR_8.RData")
  print(paste(i, "end", Sys.time()))
}
system("echo \"CR_8.R done.\" | mail -s \"Process done\" \"pantalone.fra@gmail.com\"")


# load("/Users/francesco/Google Drive/InformativeSpatialSelection/CR_8.RData")
...
# 
# pdf(file = "/Users/francesco/Google Drive/InformativeSpatialSelection/rho_12.pdf")
# par(mfrow = c(2, 2))

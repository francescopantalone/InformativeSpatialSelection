...
for(i in 1:num_cores)
{
  ...
  Numden[[i]] <- parallelrho12_server(Y = Y[[i]],
                                      ...
                                      paramd = compatible(do.call(expand.grid, list(
                                        ...
                                        .Gamma = 1))),
                                      ncores = 1)
  save(Numden, file = "CR_13.RData")
  print(paste(i, "end", Sys.time()))
}
system("echo \"CR_13.R done.\" | mail -s \"Process done\" \"pantalone.fra@gmail.com\"")


# load("/Users/francesco/Google Drive/InformativeSpatialSelection/CR_13.RData")
...
#  
# pdf(file = "/Users/francesco/Google Drive/InformativeSpatialSelection/rho_12_2_scale01.pdf")
# par(mfrow = c(2, 2))
...
# par(mfrow = c(1, 1))
# 
# pdf(file = "/Users/francesco/Google Drive/InformativeSpatialSelection/rho_12_heatmap_scale01.pdf")
# par(mfrow = c(2, 2))
# for(i in 1:length(unique(zzz_merge2$d)))
# {
#   zzz <- subset(zzz_merge2, d == unique(zzz_merge2$d)[i])

...
save(epsilon, file = "epsilon_scale1.RData")
#
  ...
  Numden[[i]] <- parallelrho_server(Y = Y[[i]],
                                    ...
                                    paramd = unique(compatible(rbind(do.call(expand.grid,list(
                                      ...
                                      do.call(expand.grid,list(
                                        ...
                                        .Gamma=1))))),
                                    ncores = 1)
  save(Numden, file = "Numden_scale1.RData")
  print(paste(i, "end", Sys.time()))
}
system("echo \"Compute_rho_server_scale1.R done.\" | mail -s \"Process done\" \"pantalone.fra@gmail.com\"")


load("/Users/francesco/Google Drive/InformativeSpatialSelection/Numden_scale1.RData")
